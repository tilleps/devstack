...
const redisCallbacks = {
   ...
   */
  health: function redisHealthCallback(redis) {
    return async function () {
   ...
   * @param {import("ioredis")} redisClient
   */
  teardown: function redisTeardownCallback(redis) {
    return async function () {
      // Destroy the connection regardless
      // Does not return any information upon success or failure
      redis.disconnect();
...
class HealthCheck {
  ...
  async getHealths() {
    ...
    for (const dependency of this._dependencies) {
      ...
      const healthCheck = new Promise(function (resolve, reject) {
        const name = dependency.name || null;
        const essential = Object.prototype.hasOwnProperty.call(dependency, "essential")
  ...
  async getTeardowns() {
    ...
    for (const dependency of this._dependencies) {
      ...
      const teardown = new Promise(function (resolve, reject) {
        const name = dependency.name || null;
